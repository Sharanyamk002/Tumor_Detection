...
image_dir = "c:\\Users\\VICTUS\\Downloads\\tumordataset\\tumordata"
...
plt.savefig('tumor_sample_accuracy_plot.png')
...
plt.savefig('tumor_sample_loss_plot.png')
...
make_prediction(cv2.imread("C:\\Users\\VICTUS\\Downloads\\tumordataset\\tumordata\\yes\\y99.jpg"),model)
print("--------------------------------------\n")
#make_prediction(cv2.imread('artifacts/cleanedbrainimage/train/no/no1.jpg'),model)
make_prediction(cv2.imread('c:\\Users\\VICTUS\\Downloads\\tumordataset\\tumordata\\no\\no70.jpg'),model)
print("--------------------------------------\n")
